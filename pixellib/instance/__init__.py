...
class instance_segmentation():
    ...
    def select_target_classes(self, BG=False, person=False, bicycle=False, car=False, motorcycle=False, airplane=False,
                              ...
                              stop_sign=False,
                              parking_meter=False, bench=False, bird=False, cat=False, dog=False, horse=False,
                              sheep=False,
                              ...
                              bottle=False, wine_glass=False, cup=False, fork=False, knife=False, spoon=False,
                              bowl=False,
                              banana=False, apple=False, sandwich=False, orange=False,
                              broccoli=False, carrot=False, hot_dog=False, pizza=False, donut=False, cake=False,
                              chair=False,
                              ...
                              oven=False, toaster=False, sink=False, refrigerator=False, book=False, clock=False,
                              vase=False,
    ...
    def segmentImage(self, image_path, show_bboxes=False, segment_target_classes=None, extract_segmented_objects=False,
        ...
        if not show_bboxes:
            ...
            output = display_box_instances(image, r['rois'], r['masks'], r['class_ids'], coco_config.class_names,
                                           r['scores'],
                                           text_size=text_size, box_thickness=box_thickness,
    ...
    def segmentBatch(self, input_folder, show_bboxes=False, segment_target_classes=None,
                ...
                for name in [".jpg", ".png", ".tif"]:
                    ...
                    if os.path.abspath(p).endswith(name):
                        ...
                        results, output = self.segmentImage(path, show_bboxes=show_bboxes,
                                                            ...
                                                            mask_points_values=mask_points_values, verbose=verbose)
    ...
    def segmentFrame(self, frame, show_bboxes=False, segment_target_classes=None, extract_segmented_objects=False,
                     text_thickness=0, text_size=0.6, box_thickness=2, save_extracted_objects=False,
        ...
        if show_bboxes == False:
            ...
            output = display_box_instances(frame, r['rois'], r['masks'], r['class_ids'], coco_config.class_names,
                                           r['scores'],
                                           text_size=text_size, box_thickness=box_thickness,
                                           text_thickness=text_thickness)
    ...
    def process_video(self, video_path, show_bboxes=False, segment_target_classes=None, extract_segmented_objects=False,
                      save_extracted_objects=False,
                      text_thickness=0, text_size=0.6, box_thickness=2, mask_points_values=False,
        ...
        while True:
            ...
            if ret:
                ...
                seg, output = self.segmentFrame(frame, show_bboxes=show_bboxes,
                                                segment_target_classes=segment_target_classes,
                                                text_thickness=text_thickness, text_size=text_size,
                                                box_thickness=box_thickness,
...
class custom_segmentation:
    ...
    def segmentImage(self, image_path, show_bboxes=False, extract_segmented_objects=False,
        ...
        if show_bboxes == False:
            ...
            output = display_box_instances(image, r['rois'], r['masks'], r['class_ids'], self.config.class_names,
                                           r['scores'],
                                           text_thickness=text_thickness, text_size=text_size,
                                           box_thickness=box_thickness)
    ...
    def segmentFrame(self, frame, show_bboxes=False, extract_segmented_objects=False,
        ...
        if show_bboxes == False:
            ...
            output = display_box_instances(frame, r['rois'], r['masks'], r['class_ids'], self.config.class_names,
                                           r['scores'],
                                           text_thickness=text_thickness, text_size=text_size,
                                           box_thickness=box_thickness)
    ...
    def process_video(self, video_path, show_bboxes=False, extract_segmented_objects=False,
                      save_extracted_objects=False,
    ...
    def process_camera(self, cam, show_bboxes=False, extract_segmented_objects=False, save_extracted_objects=False,
                       ...
                       frame_name=None, text_thickness=0, text_size=0.6, box_thickness=2, verbose=None,
                       check_fps=False):
        capture = cam
        width = int(capture.get(cv2.CAP_PROP_FRAME_WIDTH))
        height = int(capture.get(cv2.CAP_PROP_FRAME_HEIGHT))
